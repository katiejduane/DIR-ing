...
# casing should NOT matter. hint! try to use the count() method!
...
# first letter capitalized. perhaps use slices to help you out!
# capitalize("tim") # "Tim"
...
# 8
# total sum of all numbers divisible by 3 or 5 < 100
